...
| `systems/W04-L04-D024-architecture-review-agent` | Architecture Review Agent | Level 4 — Single-agent system | Planned |
| `systems/W04-L04-D023-security-review-agent` | Security Review Agent | Level 4 — Single-agent system | Planned |
| `systems/W04-L04-D022-code-explainer-agent` | Code Explainer Agent | Level 4 — Single-agent system | Planned |
...
| `systems/W02-L02-D013-code-commenter` | Code Commenter | Level 2 — Simple CLI app with one AI workflow | Planned |
