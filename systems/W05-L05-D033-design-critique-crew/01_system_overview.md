# System Overview: Design Critique Crew

## System Name

**Design Critique Crew**

## Purpose

This system solves the problem of: **Architect, security, cost, and ops agents critique a design.**

It is designed as a learning exercise at **Level 5** — a Multi-agent system with shared memory.
...
Architect, security, cost, and ops agents critique a design. Currently, this is handled manually, inconsistently, or not at all. The system automates the core workflow while keeping the architecture simple enough to understand and extend.
...
- Why this system has 2 application(s) and 2 AI agent(s)
- How data flows from input to output
- What trade-offs were made at this complexity level
- How this system prepares you for Level 6
