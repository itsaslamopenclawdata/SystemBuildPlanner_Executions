# System Overview: Bookmark Manager API
...
This system solves the problem of: **Store, tag, and retrieve bookmarks with full-text search.**

It is designed as a learning exercise at **Level 6** — a API + database system.
...
Store, tag, and retrieve bookmarks with full-text search. Currently, this is handled manually, inconsistently, or not at all. The system automates the core workflow while keeping the architecture simple enough to understand and extend.
...
- Why this system has 2 application(s) and 1 AI agent(s)
- How data flows from input to output
- What trade-offs were made at this complexity level
- How this system prepares you for Level 7
