# System Overview: Security Review Agent
...
This system solves the problem of: **Spot common security issues in code or design.**
...
Spot common security issues in code or design. Currently, this is handled manually, inconsistently, or not at all. The system automates the core workflow while keeping the architecture simple enough to understand and extend.
