# System Overview: Tweet Generator
...
This system solves the problem of: **Turn a blog post into a thread draft.**
...
Turn a blog post into a thread draft. Currently, this is handled manually, inconsistently, or not at all. The system automates the core workflow while keeping the architecture simple enough to understand and extend.
