# Inter-Application Communication: Documentation Translator
...
At Level 2, the simplest reliable pattern is chosen. We avoid message brokers, Kubernetes, or distributed tracing until the complexity genuinely demands them.
