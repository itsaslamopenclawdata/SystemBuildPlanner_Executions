# System Overview: Customer Support Crew
...
This system solves the problem of: **Triage, solve, and escalate agents handle support tickets.**
...
Triage, solve, and escalate agents handle support tickets. Currently, this is handled manually, inconsistently, or not at all. The system automates the core workflow while keeping the architecture simple enough to understand and extend.
