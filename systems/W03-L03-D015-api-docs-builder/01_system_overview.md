# System Overview: API Docs Builder
...
This system solves the problem of: **Generate API docs from code and examples.**
...
Generate API docs from code and examples. Currently, this is handled manually, inconsistently, or not at all. The system automates the core workflow while keeping the architecture simple enough to understand and extend.
