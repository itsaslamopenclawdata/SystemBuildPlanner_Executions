...
This system solves the problem of: **Manage flashcards and review sessions.**
...
Manage flashcards and review sessions. Currently, this is handled manually, inconsistently, or not at all. The system automates the core workflow while keeping the architecture simple enough to understand and extend.
