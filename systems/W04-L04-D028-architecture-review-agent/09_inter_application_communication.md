# Inter-Application Communication: Architecture Review Agent
...
At Level 4, the simplest reliable pattern is chosen. We avoid message brokers, Kubernetes, or distributed tracing until the complexity genuinely demands them.
