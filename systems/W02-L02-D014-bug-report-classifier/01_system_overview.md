# System Overview: Bug Report Classifier
...
This system solves the problem of: **Classify bug reports by severity and component.**
...
Classify bug reports by severity and component. Currently, this is handled manually, inconsistently, or not at all. The system automates the core workflow while keeping the architecture simple enough to understand and extend.
