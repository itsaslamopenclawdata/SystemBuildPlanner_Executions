# System Overview: Onboarding Crew
...
This system solves the problem of: **Agents guide a new hire through docs, tasks, and Q&A.**
...
Agents guide a new hire through docs, tasks, and Q&A. Currently, this is handled manually, inconsistently, or not at all. The system automates the core workflow while keeping the architecture simple enough to understand and extend.
