# System Overview: Decision Helper
...
This system solves the problem of: **List options, pros/cons, and recommendation for a decision.**

It is designed as a learning exercise at **Level 3** — a Multi-step AI workflow.
...
List options, pros/cons, and recommendation for a decision. Currently, this is handled manually, inconsistently, or not at all. The system automates the core workflow while keeping the architecture simple enough to understand and extend.
...
- How this system prepares you for Level 4
