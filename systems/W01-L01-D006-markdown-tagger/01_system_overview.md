# System Overview: Markdown Tagger
...
This system solves the problem of: **Auto-tag markdown notes with simple keywords.**
...
Auto-tag markdown notes with simple keywords. Currently, this is handled manually, inconsistently, or not at all. The system automates the core workflow while keeping the architecture simple enough to understand and extend.
