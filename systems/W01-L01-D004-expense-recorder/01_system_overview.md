# System Overview: Expense Recorder
...
This system solves the problem of: **Log daily expenses from CLI.**
...
Log daily expenses from CLI. Currently, this is handled manually, inconsistently, or not at all. The system automates the core workflow while keeping the architecture simple enough to understand and extend.
