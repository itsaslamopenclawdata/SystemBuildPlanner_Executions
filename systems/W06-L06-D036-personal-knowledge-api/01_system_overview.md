# System Overview: Personal Knowledge API
...
This system solves the problem of: **Expose notes, ADRs, and concepts via a REST API.**
...
Expose notes, ADRs, and concepts via a REST API. Currently, this is handled manually, inconsistently, or not at all. The system automates the core workflow while keeping the architecture simple enough to understand and extend.
